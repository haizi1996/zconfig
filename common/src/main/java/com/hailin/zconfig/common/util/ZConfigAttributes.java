...
public class ZConfigAttributes {
    ...
    static class Builder {
        ...
        public ZConfigAttributes build() {
            ...
            return new ZConfigAttributes(addresses, httpsAddresses, serverUrl, adminUrl, dev, beta, prod, resources, buildGroup, serverApp, registerSelfOnStart);
        }
    ...
    private ZConfigAttributes(String[] defaultAddresses, String[] defaultHttpsAddresses, String serverUrl, String adminUrl,
